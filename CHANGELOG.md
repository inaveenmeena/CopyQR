...
- Add a universal copy fallback when any app does not expose its selection through Accessibility.
- Leave fallback-copied text on the clipboard instead of creating an additional restoration entry in clipboard managers.
