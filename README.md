...
CopyQR normally reads the selection directly from the foreground app without changing the clipboard. If Chrome withholds a webpage selection, CopyQR copies it normally and leaves it on the clipboard. Clipboard managers such as Maccy will record that Chrome fallback copy.
